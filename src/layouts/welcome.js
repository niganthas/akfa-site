      ...
      <div className='welcome-page'>
        ...
        <div className='container'>
          ...
          <div className='nav-large'>
            <nav>
              <ul>
                ...
                <li><Link to='/partner/'>Партнерство</Link></li>
              </ul>
          ...
          <div className='nav-small'>
            <nav>
              <ul>
                <li><Link to={{}}>Kompaniya</Link></li>
                <li><Link to={{}}>Produksiya</Link></li>
                <li><Link to={{}}>Vakansii</Link></li>
                <li><Link to={{}}>Parnterstvo</Link></li>
              </ul>
        ...
        <footer className='welcome-footer'>
          ...
          <div className='ft-block contacts'>
            <div className='phone'><small>Тел.:</small> 998 71 <b>203 00 00</b></div>
            <div>100126, г.Ташкент, Учтепинский район, ул. Хирмонтепа д-1</div>
            <div className='in-eng'><Link to={{}}>in english</Link></div>
          </div>
        </footer>
        {children()}
      </div>
